...
// MyJDownloader local / Docker (e.g. jlesage) may instead expose the same
// pages over HTTPS on 127-0-0-1.mydns.jdownloader.org (or localhost.mydns…),
// which still resolves to 127.0.0.1 — treat those as loopback too.
//
...
var isLoopback = /^https?:\/\/(127\.0\.0\.1|localhost|127-0-0-1\.mydns\.jdownloader\.org|localhost\.mydns\.jdownloader\.org)(:\d+)?$/.test(window.location.origin);
